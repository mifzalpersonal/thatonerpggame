# ==============================================================================
# fast_weapon_variant.gd (Sudah Disesuaikan dengan Sistem Sentralisasi Player)
# ==============================================================================
extends Node3D
...
func shoot_slash() -> void:
	...
	if has_meta("pencipta"):
		...
		if slash_instance.has_method("set_pencipta"):
			...
			print("🎯 Berhasil oper Player via Metadata ke peluru!")
...
func mulai_cooldown() -> void:
	...
	# Bikin Timer instan lewat kode dengan batas minimal 0.05 detik biar tidak overheat
